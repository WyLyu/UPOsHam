...
f1 = lambda x: turningpoint_UPOsHam2dof.get_coordinate(model,x,0.06,e,parameters)
x0_2 = optimize.newton(f1,-0.15)
state0_2 = [x0_2,0.06,0.0,0.0]
f2 = lambda x: turningpoint_UPOsHam2dof.get_coordinate(model,x,-0.05,e,parameters)
...
[x0po_1, T_1,energyPO_1] = turningpoint_UPOsHam2dof.turningPoint(model,state0_3,state0_2 ,parameters,e,n,n_turn,po_fam_file)  
...
[x0po_2, T_2,energyPO_2] = turningpoint_UPOsHam2dof.turningPoint(model,state0_3,state0_2 ,parameters,e,n,n_turn,po_fam_file)  
...
po_fam_file = open("1111x0_turningpoint_deltaE%s_deleonberne.txt" %(deltaE),'a+')
[x0po_3, T_3,energyPO_3] = turningpoint_UPOsHam2dof.turningPoint(model,state0_3,state0_2 ,parameters,e,n,n_turn,po_fam_file)  
...
po_fam_file = open("1111x0_turningpoint_deltaE%s_deleonberne.txt" %(deltaE),'a+')
[x0po_4, T_4,energyPO_4] = turningpoint_UPOsHam2dof.turningPoint(model,state0_3,state0_2 ,parameters,e,n,n_turn,po_fam_file)  
...
cset1 = ax.contour(xMat, yMat, turningpoint_UPOsHam2dof.get_pot_surf_proj(model,xVec, yVec,parameters), [1.1,2,3,5],zdir='z', offset=0,
