...
-   [Usage](#usage)
    -   [Comparing methods for applications](#comparing-methods-for-applications)
...
![Unstable periodic orbits for De Leon-Berne Hamiltonian](tests/plots/diff_corr_deleonberne_upos.pdf)
