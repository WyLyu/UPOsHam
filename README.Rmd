...
Then ```uposham``` is available for import along with the methods and example systems as submodules, for example
...
To be sure check the modules shown in [requirements.txt](https://github.com/WyLyu/UPOsHam/tree/master/requirements.txt) are installed using
...
```
and the generated figure is located [here](tests/plots/comparison_coupled.pdf)
