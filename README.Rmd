...
This makes ```uposham``` available for import along with the methods and example systems, for example
...
![](tests/plots/diff_corr_deleonberne_upos.png){width="50.00000%"}
