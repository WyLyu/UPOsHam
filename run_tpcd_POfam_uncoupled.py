...
deltaE = e-parameters[2]
po_fam_file = open("1111x0_tpcd_deltaE%s_uncoupled.txt" %(deltaE),'a+')
[x0po_2, T_2,energyPO_2] = turningpoint_UPOsHam2dof.turningPoint_configdiff(model,state0_2,state0_3 ,parameters,e,n,n_turn,po_fam_file) ; 
...
deltaE = e-parameters[2]
po_fam_file = open("1111x0_tpcd_deltaE%s_uncoupled.txt" %(deltaE),'a+')
[x0po_3, T_3,energyPO_3] = turningpoint_UPOsHam2dof.turningPoint_configdiff(model,state0_2,state0_3 ,parameters,e,n,n_turn,po_fam_file) ; 
...
deltaE = e-parameters[2]
po_fam_file = open("1111x0_tpcd_deltaE%s_uncoupled.txt" %(deltaE),'a+')
[x0po_4, T_4,energyPO_4] = turningpoint_UPOsHam2dof.turningPoint_configdiff(model,state0_2,state0_3 ,parameters,e,n,n_turn,po_fam_file) ; 
...
deltaE = e-parameters[2]
po_fam_file = open("1111x0_tpcd_deltaE%s_uncoupled.txt" %(deltaE),'a+')
[x0po_5, T_5,energyPO_5] = turningpoint_UPOsHam2dof.turningPoint_configdiff(model,state0_2,state0_3 ,parameters,e,n,n_turn,po_fam_file) ; 
...
#cset1 = ax.contour(xMat, yMat, turningpoint_UPOsHam2dof.get_pot_surf_proj(xVec, yVec,parameters), [0.001,0.1,1,2,4],
#                       linewidths = 1.0, cmap=cm.viridis, alpha = 0.8)
cset2 = ax.contour(xMat, yMat, turningpoint_UPOsHam2dof.get_pot_surf_proj(model,xVec, yVec,parameters), [0.01,0.1,1,2,4],zdir='z', offset=0,
                       linewidths = 1.0, cmap=cm.viridis, alpha = 0.8)
