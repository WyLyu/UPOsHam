...
#eSaddle = differential_correction.get_total_energy(model,[eqPt[0],eqPt[1],0,0], parameters) #energy of the saddle eq pt
...
#                 events = lambda t,x : turning_point_coord_difference.half_period(t,x,model), \
...
te = soln.t_events[0]
tt = [0,te[2]]
#t,x,phi_t1,PHI = differential_correction.stateTransitMat(tt,x0po_1_tpcd[-1,0:4],parameters,model)
...
te = soln.t_events[0]
tt = [0,te[2]]
#t,x,phi_t1,PHI = differential_correction.stateTransitMat(tt,x0po_1_diffcorr,parameters,model)
...
te = soln.t_events[0]
tt = [0,te[2]]
#t,x,phi_t1,PHI = differential_correction.stateTransitMat(tt,x0po_1_turningpoint[-1,0:4],parameters,model)
...
te = soln.t_events[0]
tt = [0,te[2]]
#t,x,phi_t1,PHI = differential_correction.stateTransitMat(tt,x0po_1_analytic,parameters,model)
t,x,phi_t1,PHI = differential_correction.stateTransitMat(tt, x0po_1_analytic, parameters, \
                                                      varEqns_uncoupled)
