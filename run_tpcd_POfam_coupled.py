...
x=0.0
f2 = lambda y: tpcd_UPOsHam2dof.get_coordinate(model,0.0,y,e,parameters)
...
x=0.05
f3 = lambda y: tpcd_UPOsHam2dof.get_coordinate(model,x,y,e,parameters)
yanalytic = math.sqrt(2/(parameters[1]+parameters[6]))*(-math.sqrt( e +0.5*parameters[3]* x**2- 0.25*parameters[4]*x**4 -0.5*parameters[6]* x**2 + (parameters[6]*x)**2/(2*(parameters[1] +parameters[6]) )) +parameters[6]/(math.sqrt(2*(parameters[1]+parameters[6])) )*x ) #coupled
...
soln = solve_ivp(f, TSPAN, x0po_1,method='RK45',dense_output=True, events = lambda t,x : tpcd_UPOsHam2dof.half_period(t,x,model),rtol=RelTol, atol=AbsTol)
te = soln.t_events[0]
tt = [0,te[2]]
t,x,phi_t1,PHI = tpcd_UPOsHam2dof.stateTransitMat(tt,x0po_1,parameters,model)
...
f = lambda t,x : tpcd_UPOsHam2dof.Ham2dof(model,t,x,parameters) 
soln = solve_ivp(f, TSPAN, x0po_2,method='RK45',dense_output=True, events = lambda t,x : tpcd_UPOsHam2dof.half_period(t,x,model),rtol=RelTol, atol=AbsTol)
te = soln.t_events[0]
tt = [0,te[2]]
t,x,phi_t1,PHI = tpcd_UPOsHam2dof.stateTransitMat(tt,x0po_2,parameters,model)
ax = plt.gca(projection='3d')
...
f = lambda t,x : tpcd_UPOsHam2dof.Ham2dof(model,t,x,parameters) 
soln = solve_ivp(f, TSPAN, x0po_3,method='RK45',dense_output=True, events = lambda t,x : tpcd_UPOsHam2dof.half_period(t,x,model),rtol=RelTol, atol=AbsTol)
te = soln.t_events[0]
tt = [0,te[2]]
t,x,phi_t1,PHI = tpcd_UPOsHam2dof.stateTransitMat(tt,x0po_3,parameters,model)
ax = plt.gca(projection='3d')
...
f = lambda t,x : tpcd_UPOsHam2dof.Ham2dof(model,t,x,parameters) 
soln = solve_ivp(f, TSPAN, x0po_4,method='RK45',dense_output=True, events = lambda t,x : tpcd_UPOsHam2dof.half_period(t,x,model),rtol=RelTol, atol=AbsTol)
te = soln.t_events[0]
tt = [0,te[2]]
t,x,phi_t1,PHI = tpcd_UPOsHam2dof.stateTransitMat(tt,x0po_4,parameters,model)
ax = plt.gca(projection='3d')
...
f = lambda t,x : tpcd_UPOsHam2dof.Ham2dof(model,t,x,parameters) 
soln = solve_ivp(f, TSPAN, x0po_5,method='RK45',dense_output=True, events = lambda t,x : tpcd_UPOsHam2dof.half_period(t,x,model),rtol=RelTol, atol=AbsTol)
te = soln.t_events[0]
tt = [0,te[2]]
t,x,phi_t1,PHI = tpcd_UPOsHam2dof.stateTransitMat(tt,x0po_5,parameters,model)
ax = plt.gca(projection='3d')
...
cset1 = ax.contour(xMat, yMat, tpcd_UPOsHam2dof.get_pot_surf_proj(model,xVec, yVec,parameters), [0.01,0.1,1,2,4],zdir='z', offset=0,
